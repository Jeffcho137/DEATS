...
export function Delivery_selection (props) {
    ...
    const sendDelivererInfo = () => {
        ...
        .then((data) => {
            ...
            props.navigation.navigate('DeliverSearch', {
                id: id,
                name: name,
                number: number,
                email: email,
    ...
    if (!props.navigation.state.params.chosen) {
        return (
            <View style={styles.container}>
                <View style={styles.deliver_sel_input}>
                    <View style={styles.order_sel_input_box}>
                        <Button color="#006400" title='select my current location and final destination' onPress={() => props.navigation.navigate("DelMap")}></Button>
                    </View>
                </View>
        ...
        return (
            <View style={styles.container}>
                <View style={styles.deliver_sel_input}>
                    ...
                    <View style={styles.order_sel_input_box}>
                        <Text>Leaving from: {props.navigation.state.params.address1}</Text>
                        <Text>Going to: {props.navigation.state.params.address2}</Text>
                        <Button title='change my starting location and final destination' onPress={() => props.navigation.navigate("DelMap")}></Button>
                    </View>
                </View>
...
// export class Delivery_selectionC extends Component {
//     constructor(props){
//         super(props)
//         this.state = {
